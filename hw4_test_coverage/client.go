...
func (searchv *SearchClient) FindUsers(req SearchRequest) (*SearchResponse, error) {
	...
	searcherReq, err := http.NewRequest("GET", searchv.URL+"?"+searcherParams.Encode(), nil)
	searcherReq.Header.Add("AccessToken", searchv.AccessToken)
